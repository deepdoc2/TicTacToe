...
/**
 * Created by Deep.Doc on 23.01.2021.
 */
...
public class MainActivity extends AppCompatActivity {
    ...
    void SCALE() {
        ...
        // buttons text
        ((TextView) findViewById(R.id.btn_clear)).setTextSize(TypedValue.COMPLEX_UNIT_PX, DpToPx(25));
        ((TextView) findViewById(R.id.btn_sound)).setTextSize(TypedValue.COMPLEX_UNIT_PX, DpToPx(25));
